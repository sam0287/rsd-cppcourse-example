...
#include "ReactionSystem.h" // Include our own library file for describing a reaction system
...
{ // C++ uses braces to start and end sections of code.
  ...
  ReactionSystem my_simple_reaction_system("Simple reaction system"); // You can declare new variables like this.
  // "ReactionSystem" is a user defined type, or "class".
